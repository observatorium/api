...
type Authorizer interface {
	...
	Authorize(subject string, groups []string, permission Permission, resource, tenant, tenantID, token string, namespaces []string) (int, bool, string)
}
...
func (rs resources) Authorize(subject string, groups []string, permission Permission, resource, tenant,
	tenantID, token string, namespaces []string) (int, bool, string) {
