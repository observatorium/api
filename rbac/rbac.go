...
type Authorizer interface {
	...
	Authorize(subject string, groups []string, permission Permission, resource, tenant, tenantID, token string, namespaces []string, metadataOnly bool) (int, bool, string)
}
...
func (rs resources) Authorize(subject string, groups []string, permission Permission, resource, tenant,
	tenantID, token string, namespaces []string, metadataOnly bool) (int, bool, string) {
